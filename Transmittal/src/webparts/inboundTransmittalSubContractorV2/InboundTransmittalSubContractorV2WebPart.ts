...
import * as strings from 'InboundTransmittalSubContractorV2WebPartStrings';
import InboundTransmittalSubContractorV2 from './components/InboundTransmittalSubContractorV2';
import { InboundTransmittalSubContractorV2Props } from './components/InboundTransmittalSubContractorV2Props';

export interface IInboundTransmittalSubContractorV2WebPartProps {
  description: string;
}

export default class InboundTransmittalSubContractorV2WebPart extends BaseClientSideWebPart<InboundTransmittalSubContractorV2Props> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<InboundTransmittalSubContractorV2Props> = React.createElement(
      InboundTransmittalSubContractorV2,
      {
