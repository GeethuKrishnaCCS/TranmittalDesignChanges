...
export interface IInboundSubcontractorV2Props {
  ...
  inboundTransmittalHeaderList:string;
  sourceDocumentLibrary:string;
  inboundTransmittalDetailList:string;
  inboundTransmittalSitePage:string;
  revisionHistoryPage:string;
  revokePage:string;
  additionalDocumentLibrary:string;
...
export interface IInboundSubContractorState {
